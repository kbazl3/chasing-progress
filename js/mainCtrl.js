angular.module('chasingProgress')
    .controller('mainCtrl', function($scope, $sce) {
        ...
        var getOneVideo = function() {
            ...
            dailyVideo = embeddedHtml[0].video;
        ...
        // angular.element('editor').html('<iframe width="560" height="315" src="https://www.youtube.com/embed/5mvV6ZlZf8U" frameborder="0" allowfullscreen></iframe>')
